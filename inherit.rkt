...
(module+ test
  ...
  (test (expr-i->c (if0I (numI 1) (numI 2) (numI 3)) 'posn)
        (if0C (numC 1) (numC 2) (numC 3)))
  (test (expr-i->c (if0gI (numI 1) (numI 2) (numI 3)) 'posn)
        (if0gC (numC 1) (numC 2) (numC 3)))
  (test (expr-i->c (castI 'posn (numI 1) ) 'posn)
        (castC 'posn (numC 1)))
